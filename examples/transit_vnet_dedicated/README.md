...
| <a name="input_inbound_vmseries_tags"></a> [inbound\_vmseries\_tags](#input\_inbound\_vmseries\_tags) | A map of tags to be associated with the inbound virtual machines, their interfaces and public IP addresses. | `map(any)` | `{}` | no |
...
| <a name="input_outbound_vmseries_tags"></a> [outbound\_vmseries\_tags](#input\_outbound\_vmseries\_tags) | A map of tags to be associated with the outbound virtual machines, their interfaces and public IP addresses. | `map(any)` | `{}` | no |
