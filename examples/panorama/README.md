...
| <a name="input_storage_share_name"></a> [storage\_share\_name](#input\_storage\_share\_name) | Name of storage File Share to be created that will hold Panorama's boot diagnostics. | `string` | n/a | yes |
