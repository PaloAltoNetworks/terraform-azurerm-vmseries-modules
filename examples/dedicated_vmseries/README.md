...
* if you have not run Palo Alto NGFW images in a subscription it might be necessary to accept the license first ([see this note](https://github.com/PaloAltoNetworks/terraform-azurerm-vmseries-modules/blob/v1.0.0/modules/vmseries/README.md#accept-azure-marketplace-terms))
