...
| <a name="module_spoke_vmseries"></a> [spoke\_vmseries](#module\_spoke\_vmseries) | ../../modules/vmseries |  |
| <a name="module_spoke_vnet"></a> [spoke\_vnet](#module\_spoke\_vnet) | ../../modules/vnet |  |
...
| [azurerm_resource_group.spoke](https://registry.terraform.io/providers/hashicorp/azurerm/2.42/docs/resources/resource_group) | resource |
...
<<<<<<< HEAD
=======
| [azurerm_virtual_network_peering.common](https://registry.terraform.io/providers/hashicorp/azurerm/2.42/docs/resources/virtual_network_peering) | resource |
| [azurerm_virtual_network_peering.spoke](https://registry.terraform.io/providers/hashicorp/azurerm/2.42/docs/resources/virtual_network_peering) | resource |
>>>>>>> feat(example) TERRAM-59: pre-commit
...
| <a name="input_peering_common_name"></a> [peering\_common\_name](#input\_peering\_common\_name) | A name definition for peering from transit vnet to spoke vnet. | `any` | n/a | yes |
| <a name="input_peering_spoke_name"></a> [peering\_spoke\_name](#input\_peering\_spoke\_name) | A name definition for peering from spoke vnet to transit vnet. | `any` | n/a | yes |
...
| <a name="input_spoke_address_space"></a> [spoke\_address\_space](#input\_spoke\_address\_space) | The address space used by the spoke virtual network. You can supply more than one address space. | `list(string)` | n/a | yes |
| <a name="input_spoke_resource_group_name"></a> [spoke\_resource\_group\_name](#input\_spoke\_resource\_group\_name) | Name for a created resource group. | `string` | `null` | no |
| <a name="input_spoke_route_tables"></a> [spoke\_route\_tables](#input\_spoke\_route\_tables) | Definition of Route Tables to create. Refer to the `VNet` module documentation for more information. | `any` | n/a | yes |
| <a name="input_spoke_subnets"></a> [spoke\_subnets](#input\_spoke\_subnets) | Definition of Subnets to create. Refer to the `VNet` module documentation for more information. | `any` | n/a | yes |
| <a name="input_spoke_virtual_network_name"></a> [spoke\_virtual\_network\_name](#input\_spoke\_virtual\_network\_name) | The name of the spoke VNet to create. | `string` | n/a | yes |
| <a name="input_spoke_vm_offer"></a> [spoke\_vm\_offer](#input\_spoke\_vm\_offer) | Specifies the offer of the image from the Azure Marketplace | `any` | n/a | yes |
| <a name="input_spoke_vm_publisher"></a> [spoke\_vm\_publisher](#input\_spoke\_vm\_publisher) | Specifies the publisher of the spoke image. | `any` | n/a | yes |
| <a name="input_spoke_vm_size"></a> [spoke\_vm\_size](#input\_spoke\_vm\_size) | Spoke VM size (type) to be created. | `any` | n/a | yes |
| <a name="input_spoke_vm_sku"></a> [spoke\_vm\_sku](#input\_spoke\_vm\_sku) | Spoke VM SKU from Azure Marketplace. | `any` | n/a | yes |
| <a name="input_spoke_vm_version"></a> [spoke\_vm\_version](#input\_spoke\_vm\_version) | Spoke image version. | `any` | n/a | yes |
...
| <a name="input_vmspoke"></a> [vmspoke](#input\_vmspoke) | Map of virtual machines to create to run sample VM. Keys are the individual names, values<br>are the objects containing the attributes unique to that individual virtual machine:<br><br>- `avzone`: the Azure Availability Zone identifier ("1", "2", "3"). If unspecified, the Availability Set is created instead. | `any` | n/a | yes |
>>>>>>> feat(example) TERRAM-59: pre-commit
