...
| <a name="module_spoke"></a> [spoke](#module\_spoke) | Azure/compute/azurerm |  |
...
| [azurerm_resource_group.spoke](https://registry.terraform.io/providers/hashicorp/azurerm/2.58/docs/resources/resource_group) | resource |
...
| [azurerm_virtual_network_peering.common](https://registry.terraform.io/providers/hashicorp/azurerm/2.58/docs/resources/virtual_network_peering) | resource |
| [azurerm_virtual_network_peering.spoke](https://registry.terraform.io/providers/hashicorp/azurerm/2.58/docs/resources/virtual_network_peering) | resource |
...
| <a name="input_peering_common_name"></a> [peering\_common\_name](#input\_peering\_common\_name) | A name definition for peering from transit vnet to spoke vnet. | `string` | `"common_peering_example"` | no |
| <a name="input_peering_spoke_name"></a> [peering\_spoke\_name](#input\_peering\_spoke\_name) | A name definition for peering from spoke vnet to transit vnet. | `string` | `"spoke_peering_example"` | no |
...
| <a name="input_spoke_address_space"></a> [spoke\_address\_space](#input\_spoke\_address\_space) | The address space used by the spoke virtual network. You can supply more than one address space. | `list(string)` | <pre>[<br>  "10.113.0.0/16"<br>]</pre> | no |
| <a name="input_spoke_nb_public_ip"></a> [spoke\_nb\_public\_ip](#input\_spoke\_nb\_public\_ip) | Number of public IPs to assign corresponding to one IP per vm. Set to 0 to not assign any public IP addresses. | `number` | `0` | no |
| <a name="input_spoke_resource_group_name"></a> [spoke\_resource\_group\_name](#input\_spoke\_resource\_group\_name) | Name of the Resource Group to create. If not provided, it will be auto-generated. | `string` | `""` | no |
| <a name="input_spoke_route_tables"></a> [spoke\_route\_tables](#input\_spoke\_route\_tables) | Definition of Route Tables to create. Refer to the `VNet` module documentation for more information. | `map(any)` | n/a | yes |
| <a name="input_spoke_subnets"></a> [spoke\_subnets](#input\_spoke\_subnets) | Definition of Subnets to create. Refer to the `VNet` module documentation for more information. | `map(any)` | n/a | yes |
| <a name="input_spoke_virtual_network_name"></a> [spoke\_virtual\_network\_name](#input\_spoke\_virtual\_network\_name) | The name of the spoke VNet to create. | `string` | `"spoke_vnet"` | no |
| <a name="input_spoke_vm_name"></a> [spoke\_vm\_name](#input\_spoke\_vm\_name) | The VM name in Spoke Vnet. | `string` | n/a | yes |
| <a name="input_spoke_vm_offer"></a> [spoke\_vm\_offer](#input\_spoke\_vm\_offer) | Specifies the offer of the image from the Azure Marketplace | `string` | `"UbuntuServer"` | no |
| <a name="input_spoke_vm_size"></a> [spoke\_vm\_size](#input\_spoke\_vm\_size) | Spoke VM size (type) to be created. | `string` | `"Standard_DS1_v2"` | no |
