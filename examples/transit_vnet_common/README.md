...
| <a name="input_spoke_vm_name"></a> [spoke\_vm\_name](#input\_spoke\_vm\_name) | The VM name in Spoke Vnet. | `string` | `"Standard_DS1_v2"` | no |
...
| <a name="input_spoke_vm_size"></a> [spoke\_vm\_size](#input\_spoke\_vm\_size) | Spoke VM size (type) to be created. | `string` | n/a | yes |
