...
| <a name="input_common_vmseries_tags"></a> [common\_vmseries\_tags](#input\_common\_vmseries\_tags) | A map of tags to be associated with the virtual machines, their interfaces and public IP addresses. | `map(any)` | `{}` | no |
