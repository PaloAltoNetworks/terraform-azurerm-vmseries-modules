...
| <a name="input_appgw_backend_pool_id"></a> [appgw\_backend\_pool\_id](#input\_appgw\_backend\_pool\_id) | Identifier of the application gateway backend pool to associate with the public interface of each VM-Series firewall. | `string` | `null` | no |
