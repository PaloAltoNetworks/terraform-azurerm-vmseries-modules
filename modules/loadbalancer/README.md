...
| <a name="input_network_security_base_priority"></a> [network\_security\_base\_priority](#input\_network\_security\_base\_priority) | n/a | `number` | `4000` | no |
| <a name="input_network_security_group_name"></a> [network\_security\_group\_name](#input\_network\_security\_group\_name) | Name of the pre-existing NSG where to put additional rules auto-generated by frontends of this load balancer. If it's empty, user is responsible for configuring a Network Security Group separately. | `string` | `null` | no |
