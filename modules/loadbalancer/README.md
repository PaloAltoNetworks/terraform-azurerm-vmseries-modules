...
For usage see the [`transit_vnet_common`](../../examples/transit_vnet_common/README.md) or [`transit_vnet_dedicated`](../../examples/transit_vnet_dedicated/README.md) examples.
