...
variable "ssl_policy_name" {
  ...
  For the `Predefined` polcies, check the [Microsoft documentation](https://docs.microsoft.com/en-us/azure/application-gateway/application-gateway-ssl-policy-overview) for possible values as they tend to change over time.
  EOF
  default     = null
  type        = string
}
...
variable "ssl_policy_min_protocol_version" {
  description = "Minimum version of the TLS protocol for SSL Policy. Required only for `ssl_policy_type` set to `Custom`. Possible values are: `TLSv1_0`, `TLSv1_1` or `TLSv1_2`"
  default     = null
  type        = string
}
