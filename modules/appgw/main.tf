...
resource "azurerm_application_gateway" "this" {
  ...
  dynamic "url_path_map" {
    ...
    content {
      name                               = "${url_path_map.key}-pathmap"
      default_backend_address_pool_name  = "vmseries"
      default_backend_http_settings_name = "${url_path_map.key}-httpsettings"
  ...
  dynamic "request_routing_rule" {
    ...
    content {
      ...
      backend_http_settings_name = can(request_routing_rule.value.redirect.type) || can(request_routing_rule.value.url_path_maps) ? null : "${request_routing_rule.key}-httpsettings"
      ...
      url_path_map_name = can(request_routing_rule.value.url_path_maps) ? "${request_routing_rule.key}-pathmap" : null
    }
  }
