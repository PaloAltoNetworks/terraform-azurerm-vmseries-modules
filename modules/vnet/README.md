...
| <a name="input_location"></a> [location](#input\_location) | Location of the resources that will be deployed. By default, uses the location obtained from the Resource Group Data Source. | `string` | `""` | no |
